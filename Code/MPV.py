...
text5 = Label(root, text='1', font=("Arial", 18), width=18)
text5.place(x=280,y=160)
text6 = Label(root, text='2', font=("Arial", 18), width=18)
text6.place(x=280,y=195)
text7 = Label(root, text='3', font=("Arial", 18), width=18)
text7.place(x=280,y=230)
text8 = Label(root, text='Nissan, Grand Livina', font=("Arial", 18), width=18)
text8.place(x=540,y=160)
text9 = Label(root, text='Kia, Grand Carnival', font=("Arial", 18), width=18)
text9.place(x=540,y=195)
text10 = Label(root, text='Toyota, Veloz', font=("Arial", 18), width=18)
text10.place(x=540,y=230)
text11 = Label(root, text='B 6942 STU', font=("Arial", 18), width=18)
text11.place(x=800,y=160)
text12 = Label(root, text='B 666 ZE', font=("Arial", 18), width=18)
text12.place(x=800,y=195)
text13 = Label(root, text='B 69 GG', font=("Arial", 18), width=18)
text13.place(x=800,y=230)
text14 = Label(root, text='600.000 / 24 jam', font=("Arial", 18), width=18)
text14.place(x=1060,y=160)
text15 = Label(root, text='800.000 / 24 jam', font=("Arial", 18), width=18)
text15.place(x=1060,y=195)
text16 = Label(root, text='650.000 / 24 jam', font=("Arial", 18), width=18)
